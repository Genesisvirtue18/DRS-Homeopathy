...
const steps = [
  ...
  },
  {
    ...
    description:
      "Secure and easy payment process for consultation and medicine booking.",
    link: "https://shop.vagabornglobal.com/AllProducts",
    buttonText: "Pay Now",
  },
  {
    id: "03",
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="flex gap-4 overflow-x-auto pb-6 scroll-smooth md:grid md:grid-cols-3 md:gap-5 md:overflow-visible md:pb-0" 
            ...
            {steps.map((step) => {
              const CardLink = step.external ? 'a' : Link;
              ...
              return (
                <CardLink
                  key={step.id}
                  {...linkProps}
                  className="group relative w-[280px] flex-shrink-0 overflow-hidden rounded-xl bg-white p-4 text-center shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-lg md:w-auto block cursor-pointer"
                >
                  {/* Step Number - Subtle background */}
                  <div className="absolute right-3 top-3 text-3xl md:text-4xl font-black text-[#0E2A5A]/5">
                    {step.id}
                  ...
                  {/* Small Image */}
                  <div className="relative mt-2 flex justify-center">
                    <div className="rounded-lg bg-[#F7FAFF] p-2.5 md:p-3 transition-all duration-300 group-hover:bg-[#6EDC8C]/10">
                      <Image
                        src={step.image}
                        alt={step.title}
                        width={50}
                  ...
                  {/* Content - Tight spacing */}
                  <div className="mt-3">
                    <h3 className="text-[15px] md:text-[18px] font-semibold leading-[1.4] text-[#0E2A5A] transition-colors duration-300 group-hover:text-[#6EDC8C]">
                      {step.title}
                    </h3>
                  ...
                  {/* Hover Arrow - appears on hover only */}
                  <div className="mt-2.5 md:mt-3 flex items-center justify-center gap-0.5 text-[10px] md:text-[11px] font-medium text-[#6EDC8C] opacity-0 transition-all duration-300 group-hover:opacity-100">
                  ...
                  {/* Hover Border */}
                  <div className="absolute inset-0 rounded-xl border-2 border-transparent transition-all duration-300 group-hover:border-[#6EDC8C]/40" />
                </CardLink>
              );
            })}
          </div>
