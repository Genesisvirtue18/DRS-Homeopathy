...
export default function HairLossTreatmentPage() {
  ...
  const filteredImages = activeCategoryData?.gallery || [];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#001E3C] via-[#0B2C66] to-[#001E3C] pt-32 pb-16 lg:pt-36 lg:pb-20">
        <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl font-semibold text-white md:text-3xl lg:text-4xl">
            Advanced <span className="text-[#6EDC8C]">Hair Loss</span>
            <br />
            Treatment
          </h1>

          {/* <p className="mx-auto mt-4 max-w-2xl text-sm text-gray-300">
            Safe and natural homeopathy treatment for hair Loss, dandruff,
  ...
  isActive
    ? "bg-[#0E2A5A] text-white shadow-md scale-105"
...
<span className="inline-block rounded-full bg-[#0E2A5A]/10 px-3 py-1 text-xs font-medium text-[#0E2A5A]">              Showing: {activeCategoryData?.title}
            </span>
          </div>
      ...
      {/* CTA SECTION */}
      <section className="bg-gradient-to-r from-[#0E2A5A] to-[#1E3A6E] py-8">
        <div className="mx-auto max-w-5xl px-4 text-center">
          ...
          <p className="mt-1 text-xs text-gray-300 md:text-sm">
            Book your consultation with Dr. Rekha Saroha today
          </p>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2.5">
            ...
            <a
              href="tel:9911293060"
              className="inline-flex items-center gap-1.5 rounded-full bg-[#6EDC8C] px-4 py-2 text-xs font-semibold text-[#0E2A5A] shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg md:px-5 md:text-sm"
            >
            ...
            <a
              ...
              target="_blank"
              className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:bg-white/20 md:px-5 md:text-sm"
            >
